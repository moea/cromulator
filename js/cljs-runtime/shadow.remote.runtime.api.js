...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18702 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18702(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18719 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18719(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18738 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18738(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18747 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18747(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18761 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18761(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18765 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18765(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18636,callback){
var map__18637 = p__18636;
var map__18637__$1 = cljs.core.__destructure_map(map__18637);
var input = map__18637__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18637__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18637__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
