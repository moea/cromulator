...
var i_18592 = (0);
while(true){
if((i_18592 < arr.length)){
(arr[i_18592] = null);

var G__18593 = (i_18592 + (1));
i_18592 = G__18593;
continue;
} else {
}
...
var i_18613 = (self__.level + (1));
while(true){
if((i_18613 <= (new_level + (1)))){
(update[i_18613] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_18616 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_18616[i]));
} else {
x__$2.forward.push((((i < links_18616.length))?(links_18616[i]):null));
}

if((i < links_18616.length)){
(links_18616[i] = x__$2);
} else {
links_18616.push(x__$2);
}
...
var i_18633 = (0);
while(true){
if((i_18633 <= self__.level)){
var links_18635 = (update[i_18633]).forward;
if((x__$1 === (((i_18633 < links_18635.length))?(links_18635[i_18633]):null))){
(links_18635[i_18633] = (x__$1.forward[i_18633]));

var G__18646 = (i_18633 + (1));
i_18633 = G__18646;
continue;
} else {
var G__18651 = (i_18633 + (1));
i_18633 = G__18651;
continue;
}
} else {
...
var G__18703 = nx;
var G__18704 = (level__$1 - (1));
x = G__18703;
level__$1 = G__18704;
continue;
} else {
var G__18707 = x;
var G__18708 = (level__$1 - (1));
x = G__18707;
level__$1 = G__18708;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__18722 = nx;
var G__18723 = (level__$1 - (1));
x = G__18722;
level__$1 = G__18723;
continue;
} else {
var G__18724 = x;
var G__18725 = (level__$1 - (1));
x = G__18724;
level__$1 = G__18725;
continue;
}
